        ...
        {messages.map((msg, index) => (
          ...
          >
            ...
            {msg.image ? (
              ...
              <p
                className={`p-2 max-w-[70vw] sm:max-w-[200px] text-xs sm:text-sm font-light rounded-lg mb-6 break-words bg-violet-500/30 text-white ${
                  msg.senderId === authUser._id
                    ? "rounded-br-none"
                    : "rounded-bl-none"
                }`}
        ...
        <div className="flex-1 flex items-center bg-gray-100/12 px-3 rounded-full">
          ...
          <label htmlFor="image">
            <img
              ...
              alt=""
              className="w-4 sm:w-5 mr-2 cursor-pointer"
            />
          </label>
        </div>
